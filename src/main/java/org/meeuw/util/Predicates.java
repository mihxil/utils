...
public final class Predicates {
    ...
    protected static abstract  class TriWrapper<W, X, Y, Z> extends Functions.Wrapper<W> implements TriPredicate<X, Y, Z> {
        public TriWrapper(W wrapped, Object value, String why) {
            super(wrapped, value, why);
        }
    }
    protected static abstract  class BiWrapper<W, X, Y>  extends Functions.Wrapper<W> implements BiPredicate<X, Y> {
        public BiWrapper(W wrapped, Object value, String why) {
            super(wrapped, value, why);
        }
    }

    protected static abstract  class MonoWrapper<W, X>  extends Functions.Wrapper<W> implements Predicate<X> {
