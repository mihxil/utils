...
image:https://img.shields.io/nexus/s/https/oss.sonatype.org/org.meeuw.utils/mihxil-functional.svg[snapshots,link=https://oss.sonatype.org/content/repositories/snapshots/org/meeuw/utils/]
